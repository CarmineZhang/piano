<template>
  <div class="news">
    ...
    <div class="news-list">
      <div class="list-item">
        <div class="item-wrapper" :class="{'item-wrapper-1':index%2==1}" v-for="(item,index) in even" :key="item.id" @click="showNew(item.id)">
      ...
      <div class="list-item">
        <div class="item-wrapper" :class="{'item-wrapper-1':index%2==0}" v-for="(item,index) in odd" :key="item.id" @click="showNew(item.id)">
          <img :src="item.imageAddr" alt="">
          <div class="item">
            <div class="item-title" v-text="item.title"></div>
            <div class="item-content" v-text="item.summary"></div>
